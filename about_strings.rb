...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # If you want to make a new variable and not affec the existing, use +=
    # If you want to affect the original pointer, use shovels, or <<

    # My guess is that programmers favor the shovel operator (<<) so as not to cause confusion of which variable contains the updated string
  end
