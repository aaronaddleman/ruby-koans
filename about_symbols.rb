...
class AboutSymbols < Neo::Koan
  ...
  # Because if you dont convert, you would be comparing their object_id and no the content of the identifer
  ...
  # Could cause for to many pointers taking up memory until the program exits
end
